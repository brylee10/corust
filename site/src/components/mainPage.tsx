...
function MainPage({ currUser }: MainPageProps) {
  ...
  const enqueueCustomSnackbar = useCallback((html: ReactElement) => {
    enqueueSnackbar(html, {
      // Style mirrors the `channel` and `optLevel` colors,
      // secondary button colors
      style: {
        backgroundColor: themeRef.current.palette.secondary.main,
        color: "black",
      },
      action: (key) => (
        <IconButton
